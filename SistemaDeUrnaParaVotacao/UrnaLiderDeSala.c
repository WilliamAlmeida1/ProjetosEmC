...
int main(){
    ...
    printf("\n---\nQuantidade de pessoas que votaram: [%d]\n", pessoas);
    ...
    printf("Quantidade de pessoas que votaram NULO ou INVALIDO: [%d]\n", candidatos[4]);
        if(candidatos[1] > candidatos[2] && candidatos[1] > candidatos[3]){
        printf("Ganhador da votação: Ailson Salviano\n");
    }else if(candidatos[2] > candidatos[1] && candidatos[2] > candidatos[3]){
        printf("Ganhador da votação: Danis Daniel\n");
    }else if(candidatos[3] > candidatos[1] && candidatos[3] > candidatos[2]){
