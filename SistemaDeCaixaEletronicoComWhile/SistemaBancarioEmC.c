...
int main(){
    ...
    float saldo = 0, tran;//variaveis para saldo e valor da transação
    int operacao, sair = 0;//variavel que guarda o tipo de transação e a outra que guarda uma condição para continuar rodando
